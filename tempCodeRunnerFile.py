...
paper_img = ImageTk.PhotoImage(Image.open("paper-user"))
scissor_img = ImageTk.PhotoImage(Image.open(
    r"c:\Users\hp\OneDrive\Desktop\game1\scissor-paper-rock\scissors-user.png"))
rock_img_comp = ImageTk.PhotoImage(Image.open(
    r"c:\Users\hp\OneDrive\Desktop\game1\scissor-paper-rock\rock.png"))
paper_img_comp = ImageTk.PhotoImage(Image.open(
    r"c:\Users\hp\OneDrive\Desktop\game1\scissor-paper-rock\paper.png"))
scissor_img_comp = ImageTk.PhotoImage(Image.open(
    r"c:\Users\hp\OneDrive\Desktop\game1\scissor-paper-rock\scissors.png"))
...
# for user
    if x == "rock":
        user_label.configure(image=rock)
    elif x == "paper":
        user_label.configure(image=paper)
    else:
        user_label.configure(image=scissor)
